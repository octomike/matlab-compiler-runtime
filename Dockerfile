...
RUN mkdir /opt/mcr_install && \
    mkdir /opt/mcr && \
    wget --quiet -P /opt/mcr_install https://ssd.mathworks.com/supportfiles/downloads/R2024a/Release/5/deployment_files/installer/complete/glnxa64/MATLAB_Runtime_R2024a_Update_5_glnxa64.zip && \
