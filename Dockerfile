...
RUN mkdir /opt/mcr_install && \
    mkdir /opt/mcr && \
    wget --quiet -P /opt/mcr_install https://ssd.mathworks.com/supportfiles/downloads/R2024b/Release/7/deployment_files/installer/complete/glnxa64/MATLAB_Runtime_R2024b_Update_7_glnxa64.zip && \
...
ENV MCR_VERSION v242
ENV MCR_RELEASE R2024b
