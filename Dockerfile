...
# Install MATLAB MCR
ENV MATLAB_VERSION R2025a
RUN mkdir /opt/mcr_install && \
    mkdir /opt/mcr && \
    wget --quiet -P /opt/mcr_install https://ssd.mathworks.com/supportfiles/downloads/R2025a/Release/1/deployment_files/installer/complete/glnxa64/MATLAB_Runtime_R2025a_Update_1_glnxa64.zip && \
...
ENV MCR_VERSION v251
ENV MCR_RELEASE R2025a
