...
RUN mkdir /opt/mcr_install && \
    mkdir /opt/mcr && \
    wget --quiet -P /opt/mcr_install https://ssd.mathworks.com/supportfiles/downloads/R2023a/Release/3/deployment_files/installer/complete/glnxa64/MATLAB_Runtime_R2023a_Update_3_glnxa64.zip && \
