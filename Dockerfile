...
# Install MATLAB MCR
ENV MATLAB_VERSION R2025b
RUN mkdir /opt/mcr_install && \
    mkdir /opt/mcr && \
    wget --quiet -P /opt/mcr_install https://ssd.mathworks.com/supportfiles/downloads/R2025b/Release/2/deployment_files/installer/complete/glnxa64/MATLAB_Runtime_R2025b_Update_2_glnxa64.zip && \
...
ENV MCR_VERSION v252
ENV MCR_RELEASE R2025b
