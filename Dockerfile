...
# Install MATLAB MCR
ENV MATLAB_VERSION R2024a
RUN mkdir /opt/mcr_install && \
    mkdir /opt/mcr && \
    wget --quiet -P /opt/mcr_install https://ssd.mathworks.com/supportfiles/downloads/R2024a/Release/3/deployment_files/installer/complete/glnxa64/MATLAB_Runtime_R2024a_Update_3_glnxa64.zip && \
...
ENV MCR_VERSION v241
ENV MCR_RELEASE R2024a
